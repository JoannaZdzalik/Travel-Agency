...
class TravelagencyApplicationTests {
	...
	public void shouldCreateClientWithAllValidParameters() {
		...
		Assert.assertEquals("Client added sucessfully",clientService.addClient(clientDto));
	}
	...
	public void shouldNotCreateClientPassportNrDuplicate() {
		...
		Assert.assertEquals("This passport number already exists in db!", clientService.addClient(clientDuplicate));
	}
